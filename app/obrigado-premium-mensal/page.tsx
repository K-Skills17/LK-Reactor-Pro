        ...
        <div className="max-w-4xl mx-auto text-center space-y-6">
          ...
          <div className="bg-white/20 backdrop-blur-sm rounded-2xl p-6 inline-block">
            <div className="flex items-center gap-3 justify-center mb-3">
              ...
              <span className="text-2xl sm:text-3xl font-bold">PLANO PREMIUM - MENSAL</span>
            </div>
            <p className="text-xl text-white/90">
              Assinatura ativa • R$ 497/mês • 14 dias grátis
            </p>
            <div className="inline-flex items-center gap-2 px-4 py-2 bg-yellow-400/20 backdrop-blur-sm rounded-full mt-3">
              <Star className="w-5 h-5 text-yellow-300" />
              <span className="font-bold">Você escolheu o melhor plano!</span>
              <Star className="w-5 h-5 text-yellow-300" />
            </div>
          </div>
        </div>
        ...
        <section className="bg-white rounded-2xl shadow-xl p-6 sm:p-8 border-2 border-purple-200">
          <div className="text-center mb-8">
            ...
            <p className="text-gray-600">
              Todos os recursos PREMIUM + IA avançada desbloqueados
            </p>
          </div>
          ...
          <div className="bg-gradient-to-r from-purple-600 to-pink-600 rounded-xl p-6 text-white text-center">
            ...
            <p className="text-sm text-white/90">
              Depois do período de teste, apenas R$ 497/mês
            </p>
          </div>
        </section>
