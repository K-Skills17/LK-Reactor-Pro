...
export default function ObrigadoProMensalPage() {
  return (
        ...
        <div className="max-w-4xl mx-auto text-center space-y-6">
          ...
          <div className="bg-white/20 backdrop-blur-sm rounded-2xl p-6 inline-block">
            <div className="flex items-center gap-3 justify-center mb-3">
              ...
              <span className="text-2xl sm:text-3xl font-bold">PLANO PROFESSIONAL - MENSAL</span>
            </div>
            <p className="text-xl text-white/90">
              Assinatura ativa • R$ 197/mês • 14 dias grátis
            </p>
          </div>
        </div>
      </section>
      ...
      <div className="max-w-4xl mx-auto p-4 sm:p-6 md:p-8 space-y-8">
        ...
        <section className="bg-white rounded-2xl shadow-xl p-6 sm:p-8 border-2 border-blue-200">
          <div className="text-center mb-8">
            ...
            <p className="text-gray-600">
              Todos os recursos do plano PROFESSIONAL estão ativos
            </p>
          </div>
          ...
          <div className="bg-gradient-to-r from-blue-600 to-purple-600 rounded-xl p-6 text-white text-center">
            ...
            <p className="text-sm text-white/90">
              Depois do período de teste, apenas R$ 197/mês
            </p>
          </div>
        </section>
        ...
        <section className="bg-gradient-to-br from-purple-50 to-pink-50 rounded-2xl shadow-lg p-6 sm:p-8 border-2 border-purple-300">
          ...
          <div className="bg-white rounded-xl p-5 border-2 border-purple-200 mb-4">
            ...
            <p className="text-3xl font-bold text-purple-600 mb-3">R$ 497/mês</p>
